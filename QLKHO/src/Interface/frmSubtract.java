 ...
 * @author Astronaut
 */
public class frmSubtract extends javax.swing.JFrame {

    /**
     * Creates new form frmSubtract
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSubtract.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSubtract().setVisible(true);
            }
        });
    }
